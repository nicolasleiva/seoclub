...
export const metadata = {
  ...
  description: "Clone this open-source Next.js blog post template to launch blazing-fast, SEO-ready articles in minutes. Star the repo and start writing today!"
}
