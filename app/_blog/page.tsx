...
// Separamos el contenido principal en un componente hijo para evitar problemas con useSearchParams
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6">Blog de Cacerola</h1>
                      ...
                      >
                        <CardContent className="p-0">
                          <div className="relative">
                            <img
                              src={`/placeholder.svg?height=${post.featured ? "300" : "200"}&width=${post.featured ? "800" : "400"}&text=${encodeURIComponent(post.title)}`}
                              alt={post.title}
